...
def build_provider_routing_hint(config: AgentConfig, inference_request: InferenceRequest) -> dict[str, Any]:
    ...
    topology_subgraph = reasoning_seed.get("topology_subgraph") or {}
    ...
    return {
        ...
        "topology_subgraph_id": topology_subgraph.get("subgraph_id") or "",
        "should_invoke_llm": bool(invocation_gate.get("should_invoke_llm")),
        "llm_budget_tier": invocation_gate.get("budget_tier") or "",
